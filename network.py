...
class QNetwork(nn.Module):
    def __init__(self, state_size, action_size, hyperparams):
        ...
        layer1_size = hyperparams.get("layer1_size", 256)
        layer2_size = hyperparams.get("layer2_size", 256)
        init_w = hyperparams.get("init_w", 3e-3)
...
class GaussianPolicyNetwork(nn.Module):
    def __init__(self, state_size, action_size, hyperparams):
        ...
        layer2_size = hyperparams.get("layer2_size", 256)
        init_w = hyperparams.get("init_w", 3e-3)
        self.log_std_min = hyperparams.get("log_std_min", -20)
        self.log_std_max = hyperparams.get("log_std_max", 2)
